...
<table class="table table-bordered table-data mar0 tab-con">
              <thead>
                <tr> 
                  ...
                  <th rowspan="2">Make <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> vehicle_sort_retainer" data-by="t_Makes.Make_Name" data_id="<?php echo $sorting_id;?>"></a></th> 
                  <th rowspan="2">Model <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> vehicle_sort_retainer" data-by="t_Models.Model_Name" data_id="<?php echo $sorting_id;?>"></a></th> 
                  <th rowspan="2">Year <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> vehicle_sort_retainer" data-by="t_Vehicles.Years" data_id="<?php echo $sorting_id;?>"></a></th>
                ...
                <tr>               
                  ...
                  <th class="AutoProPAD <?php echo $autopropad_hide;?>">Add-A-Key
                   <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> vehicle_sort_retainer" data-by="APP_Add_Keys" data_id="<?php echo $sorting_id;?>"></a>
                  </th>
                  <th class="AutoProPAD <?php echo $autopropad_hide;?>">All-Keys-Lost
                  <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> vehicle_sort_retainer" data-by="APP_All_Keys_Lost" data_id="<?php echo $sorting_id;?>"></a>
                  </th>
                  <th class="AutoProPAD <?php echo $autopropad_hide;?>">PIN Read 
                  <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> vehicle_sort_retainer" data-by="PIN_Read" data_id="<?php echo $sorting_id;?>"></a>
                  </th>
