    ...
    <div class="col-sm-3">
      ...
      <div class="col-sm-12">
        <div class="form-group addCodeSeries">          
          <a href="<?php echo adm_base_url();?>vehicles/add_machanical_keys" class="btn btn-danger"  title="Sign Out">Add New Key</a>        
        </div>
      </div>
    </div>
</div>
              ...
              <tbody>
                ...
                foreach($results as $value){?>
                    <tr> 
                        ...
                        <td><?php echo $value['code_series'];?></td>
                        ...
                        <td>
                          <a  href="<?php echo adm_base_url();?>vehicles/edit_machanical_keys/<?php echo $value['id'];?>" type="button" class="btn btn-success">Edit</a> 
                          <a  href="javascript:void(0)" onClick="DeleteKeytype(<?php echo $value['id'];?>, '<?php echo adm_base_url();?>vehicles/delete_machanical_keys/')" type="button"class="btn btn-danger">Delete</a>
                        </td>                     
                    </tr> 
                <?php }?>
               </tbody>
