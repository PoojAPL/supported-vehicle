    ...
    <div class="col-sm-24 col-md-24">
      ...
      <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
        ...
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
              <?php $years = explode(',',$getVehiclesInfo[0]['Years']);?>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
           ...
           <input type="hidden" name="Vehicle_Image_copy"  value="<?php echo $getVehiclesInfo[0]['image_url'];?>" />
           <div id="imageProgress"> <div id="imageBar" class="progress-bar-striped"></div> </div>         
            </div>
          </div>
        <!--  <div class="col-sm-2"><button type="button" id="btn" class="btn btn-info vehicle_images">Upload</button></div> id="image_vale" -->
          <div class="col-sm-2"> <img  src="<?php echo $getVehiclesInfo[0]['Vehicle_Image'];?>"  style="width: 80px;height: 46px;" /> </div>   
   
           <div class="col-sm-2"> <img src="/vh-admin/assets/vehicleImages/150/<?php echo $getVehiclesInfo[0]['Vehicle_Image'];?>"style="width: 80px;height: 46px;">
         </div>
        </div>
        <div class="row">
          <div class=" col-sm-4 ">
        ...
        <fieldset>
          <legend>AutoProPAD</legend>
			...
			<div class="row">
              ...
              <div class="col-sm-10">
                <div class="inputcol">
                  <input type="text" class="form-control" name="Key_Blade"  value="<?php echo $getVehiclesInfo[0]['Key_Blade'];?>"/>
                </div>
              </div>
            </div>
			 <div class="row">
              ...
              <div class="col-sm-10">
                <div class="inputcol">
                  <input type="text" class="form-control" name="Transponder_Chip"  value="<?php echo $getVehiclesInfo[0]['Transponder_Chip'];?>"/>
                </div>
              </div>
            </div>
        </fieldset>
