...
<div id="right-container">
                ...
                <select class="form-control select-field show_keysby_types">
                	<option value="all">All</option>                    
            		  <?php foreach($getAllkeyType as $chips){
						  ...
						  if($chips['UUID'] == "391021e9-3d59-11e6-8f40-525400180921" || $chips['UUID'] ==    "9ec3b5aa-5f3c-11e6-8f40-525400180921"|| $chips['UUID'] == "f7d51503-5f40-11e6-8f40-525400180921" || $chips['UUID'] == "64fdab36-5d84-11ea-b438-52540038e04e" || $chips['UUID'] == "fdf77a40-3d5a-11e6-8f40-525400180921" || $chips['UUID'] == "ea244906-4d80-11e6-8f40-525400180921"){ }else{?>
  ...
  <div class="row">
    <div class="col-sm-21"> </div>
      <div class="col-sm-3">
        <div class="form-group">          
          <a href="<?php echo adm_base_url();?>home/add_key" class="btn btn-danger" >Add New Key</a>        
        </div>
      </div>
  </div>    
  <div class="row">
          ...
          <div class="table-responsive chips_data" style="overflow:visible">
            <table class="table table-bordered table-data mar0 tab-con">
              ...
              foreach($results as $value){
                ...
                ?>
                    <tr <?php echo $bgcolor;?>> 
                    <td><a  href="<?php echo adm_base_url();?>home/edit_key/<?php echo $value['id'];?>" type="button" class="btn btn-success" >Edit</a>
                        <a  href="<?php echo adm_base_url();?>home/copy_key/<?php echo $value['id'];?>" type="button" class="btn btn-info" >Copy</a>
                        <a  href="javascript:void(0)" onclick="DeleteChipsFunction(<?php echo $value['id'];?>, '<?php echo adm_base_url();?>home/delete_key/')" type="button"class="btn btn-danger" >Delete</a>
                     </td>  
