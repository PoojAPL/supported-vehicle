...
if( isset($this->session->userdata['code_series_pagination'])){
	$per_page1 = $this->session->userdata['code_series_pagination'];
...
<table class="table table-bordered  table-data mar0 tab-con">
    <thead>
      <tr class="first_tr">
          ...
          <th rowspan="2">Name
          <?php if($sorting_by == 'Code_Series_Name'){?>
          <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Code_Series_Name" data_id="<?php echo $sorting_id;?>"></a>          
          <?php }else{ ?>
          ...
          <th rowspan="2">Spaces
          <?php if($sorting_by == 'Spaces'){?>
          <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Spaces" data_id="<?php echo $sorting_id;?>"></a> 
           <?php }else{ ?>
          ...
          <th rowspan="2">Depths
          <?php if($sorting_by == 'Depths'){?>
          <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Depths" data_id="<?php echo $sorting_id;?>"></a> 
          <?php }else{ ?>
          ...
          <th rowspan="2">MACS
          <?php if($sorting_by == 'MACS'){?>
          <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="MACS" data_id="<?php echo $sorting_id;?>"></a> 
           <?php }else{ ?>
          ...
          <th rowspan="2">Key Style
           <?php if($sorting_by == 'Key_Style_UUID'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Key_Style_UUID" data_id="<?php echo $sorting_id;?>"></a> 
           <?php }else{ ?>
          ...
          <?php if($sorting_by == 'First_Cut'){?>
          <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="First_Cut" data_id="<?php echo $sorting_id;?>"></a> 
           <?php }else{ ?>
          ...
          <?php if($sorting_by == 'Space_Between_Cuts'){?>
          <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Space_Between_Cuts" data_id="<?php echo $sorting_id;?>"></a> 
          <?php }else{ ?>
          ...
          <?php if($sorting_by == 'Determinator_UUID'){?>
          <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Determinator_UUID" data_id="<?php echo $sorting_id;?>"></a> 
           <?php }else{ ?>
          ...
          <th rowspan="2" class="decoder <?php echo $decoder_hide;?>">Lishi
           <?php if($sorting_by == 'Lishi_UUID'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Lishi_UUID" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
          ...
          <th rowspan="2" class="decoder <?php echo $decoder_hide;?>">Accu-Reader
          </th>
          <th rowspan="2" class="decoder <?php echo $decoder_hide;?>">EEZ-Reader
          <th rowspan="2" class="decoder <?php echo $decoder_hide;?>">Space &amp; Depth Keys
           <?php if($sorting_by == 'SDKeys_UUID'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="SDKeys_UUID" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
          ...
          <?php if($sorting_by == 'TryOutKeys_UUID'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="TryOutKeys_UUID" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
          ...
          <?php if($sorting_by == 'BuildAKey_UUID'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="BuildAKey_UUID" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
          ...
          <?php if($sorting_by == 'A1AutoPicks_UUID'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="A1AutoPicks_UUID" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
      ...
      <tr>
        ...
        <?php if($sorting_by == 'HPC_Blitz_Card'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="HPC_Blitz_Card" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'HPC_Blitz_Cutter'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="HPC_Blitz_Cutter" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'HPC_Blitz_Position'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="HPC_Blitz_Position" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'HPC_Blitz_Side'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="HPC_Blitz_Side" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'Silca_Card'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Silca_Card" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Silca Cutter
         <?php if($sorting_by == 'Silca_Cutter'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="Silca_Cutter" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Card
        <?php if($sorting_by == 'HPC_Punch_Card'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="HPC_Punch_Card" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'HPC_Punch_Punch'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="HPC_Punch_Punch" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Side
        <?php if($sorting_by == 'HPC_Punch_Side'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="HPC_Punch_Side" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'HPC_CodeMax_DSD'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="HPC_CodeMax_DSD" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Side
           <?php if($sorting_by == 'HPC_CodeMax_Side'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="HPC_CodeMax_Side" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Position
           <?php if($sorting_by == 'HPC_CodeMax_Position'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="HPC_CodeMax_Position" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Cutter
        	<?php if($sorting_by == 'HPC_CodeMax_Cutter'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="HPC_CodeMax_Cutter" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">ID
        	<?php if($sorting_by == 'ITL_ID'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="ITL_ID" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Insert
        	<?php if($sorting_by == 'ITL_Insert'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="ITL_Insert" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'Curtis_CamSet'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Curtis_CamSet" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'Curtis_Carriage'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Curtis_Carriage" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Cutter
        <?php if($sorting_by == 'Curtis_Cutter'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Curtis_Cutter" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'Keyline_Ninja_Vice'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="Keyline_Ninja_Vice" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Side
        <?php if($sorting_by == 'Keyline_Ninja_Side'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Keyline_Ninja_Side" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Position
        <?php if($sorting_by == 'Keyline_Ninja_Position'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Keyline_Ninja_Position" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Cutter
        <?php if($sorting_by == 'Keyline_Ninja_Cutter'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="Keyline_Ninja_Cutter" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'Pak_QCKit'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="Pak_QCKit" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Vise
        <?php if($sorting_by == 'Pak_Vise'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Pak_Vise" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Punch
        <?php if($sorting_by == 'Pak_Punch'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="Pak_Punch" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'Pak_Die'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="Pak_Die" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'Framon_Block'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Framon_Block" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Cutter
        <?php if($sorting_by == 'Framon_Cutter'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="Framon_Cutter" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'Framon_FirstCut'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Framon_FirstCut" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Between Cuts
         <?php if($sorting_by == 'Framon_BetweenCuts'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="Framon_BetweenCuts" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'SW2_SpaceRod'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="SW2_SpaceRod" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'SW2_DepthRod'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="SW2_DepthRod" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'SW2_ViseSet'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="SW2_ViseSet" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Stop
         <?php if($sorting_by == 'SW2_Stop'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="SW2_Stop" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">DSD
        <?php if($sorting_by == 'LKP_3DX_DSD'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_sort" data-by="LKP_3DX_DSD" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'LKP_3DX_Jaw'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="LKP_3DX_Jaw" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <?php if($sorting_by == 'LKP_3DX_JawClamp'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="LKP_3DX_JawClamp" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Stop 
        <?php if($sorting_by == 'LKP_3DX_Stop'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="LKP_3DX_Stop" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
        ...
        <th class="machine <?php echo $machine_hide;?>">Cutter
        <?php if($sorting_by == 'LKP_3DX_Cutter'){?>
           <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> code_series_uuid_sort" data-by="LKP_3DX_Cutter" data_id="<?php echo $sorting_id;?>"></a>
            <?php }else{ ?>
