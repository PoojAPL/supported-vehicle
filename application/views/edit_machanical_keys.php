<div class="container-fluid">
  ...
  <?php } ?>
  <form class="site-form "  id="key_type" method ="post"  action="<?php echo adm_base_url();?>vehicles/update_machanical_keys/<?php echo $result[0]['id'];?>" enctype='multipart/form-data' >
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="text" class="form-control" value="<?php echo $result[0]['code_series'];?>"  name="code_series" >
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="text" class="form-control" value="<?php echo $result[0]['depth'];?>"  name="depth" >
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="text" class="form-control" value="<?php echo $result[0]['ignition'];?>"  name="ignition" >
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="text" class="form-control" value="<?php echo $result[0]['macs'];?>" name="macs" >
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="text" class="form-control" value="<?php echo $result[0]['spaces'];?>" name="spaces" >
        </div>
      </div>
    </div>
    <div class="row">
